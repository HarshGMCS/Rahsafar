        ...
        <div class="card p-4 border-0 shadow">
            ...
            <div class="row">
                ...
                <div class="col-6 text-right">
                    {{ fare_quote.Fare.BaseFare.toFixed(2)}}
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-6 text-right">
                   {{ fare_quote.Fare.OtherCharges.toFixed(2)}}
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-6 text-right">
                   INR {{ fare_quote.Fare.PublishedFare.toFixed(2) }}
                </div>
            </div>
        </div>
    </div>
...
<script>
    const app = Vue.createApp({
        data() {
            ...
            return {
                flight:<?php echo isset($search["Response"]["Results"][0][$id]) ? json_encode($search["Response"]["Results"][0][$id]) : null;?>,
    ...
    <script>
        $(document).ready(function(){
           ...
           $('#payment-form').on('submit', function(event) {
                ...
                var amount = Math.ceil(window.fareData.Fare.PublishedFare);
                $.ajax({
                                    ...
                                    success: function(data) {
                                        $.ajax({
                                            ...
                                            success: function(response) {
                                                ...
                                                window.location.href = 'book_ticket.php?id=<?php echo $_GET['id']; ?>';
                                            },
                                            error: function(xhr, status, error) {
